    ...
    >
      <div className="flex items-start gap-3 mb-4">
        ...
        <div className="flex-1 min-w-0">
          <h4 className="text-sm font-medium text-text-primary truncate" title={document.name}>{document.name}</h4>
          <div className="flex items-center gap-2 mt-1">
            <span className="text-xs font-semibold text-text-secondary uppercase">{document.type}</span>
      ...
      <div className="mt-auto flex items-end justify-between border-t border-border pt-3">
        <div>
          ...
          <div className="text-xs font-medium text-text-primary truncate max-w-[100px]">{document.uploadedBy}</div>
        </div>
