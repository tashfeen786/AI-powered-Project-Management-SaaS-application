      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center gap-6">
          <div className="w-20 h-20 bg-background border border-border rounded-lg flex items-center justify-center text-text-secondary shrink-0 overflow-hidden relative group cursor-pointer">
            <span className="text-2xl font-bold">{((settings as any).name || (settings as any).general?.name || "O").charAt(0)}</span>
          ...
          <div className="flex-1">
            ...
            <input 
              type="text" 
              value={(settings as any).name || (settings as any).general?.name || ""}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input 
              type="text" 
              value={(settings as any).industry || (settings as any).general?.industry || ""}
          ...
          <div>
            ...
            <input 
              type="url" 
              value={(settings as any).website || (settings as any).general?.website || ""}
        ...
        <div>
          ...
          <textarea 
            value={(settings as any).description || (settings as any).general?.description || ""}
        ...
        <div>
          ...
          <input 
            type="text" 
            value={(settings as any).id || (settings as any).general?.id || ""}
            readOnly
